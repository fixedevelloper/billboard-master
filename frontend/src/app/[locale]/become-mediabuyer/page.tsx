...
import { extractErrorMessage, registerMediaBuyer } from "@/lib/api";
import { useAuth } from "@/lib/AuthProvider";

export default function BecomeMediaBuyerPage() {
  const t = useTranslations("mediaBuyerBecome");
          ...
          {success ? (
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
              ...
              <Input
                ...
                onChange={updateField("creditLimit")}
                required
